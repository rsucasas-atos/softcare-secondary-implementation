...
/**
 * Any identifier used by a healthcare facility to uniquely identify a person
 * (e.g. medical record number, birth registry, national unique individual
 * identifier, Passport ID, etc.).
 * 
 * <p>
