...
/**
 * Any physical measurement, such as blood pressure, heart rate, weight,
 * activity or sleep quality information, etc.
 * 
 * <p>
...
@XmlType(name = "Measurement", propOrder = { "type", "value", "dateTime",
		"units", "lowerLimit", "upperLimit", "taskID", "field1", "field2" })
