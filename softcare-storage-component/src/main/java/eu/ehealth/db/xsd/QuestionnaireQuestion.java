...
/**
 * Definition of a question contained in the patients or carers questionnaire.
 * The question may contain a list of sub-questions, that must be presented to
 * the user only if the condition specified by the condition attribute is
 * fulfilled e.g. only when the user answers YES to that question.
 * 
 * <p>
 * Clase Java para QuestionnaireQuestion complex type.
 * 
 * <p>
...
@XmlType(name = "QuestionnaireQuestion", propOrder = { "title", "globalID",
		"answers", "questions", "position" })
public class QuestionnaireQuestion
{
	 ...
	 * 
	 * @return possible object is {@link QuestionnaireQuestionAnswerList }
	 * 
	 */
	 ...
	 * 
	 * @param value allowed object is {@link QuestionnaireQuestionAnswerList }
	 * 
	 */
	 ...
	 * 
	 * @return possible object is {@link QuestionnaireQuestionList }
	 * 
	 */
	 ...
	 * 
	 * @param value allowed object is {@link QuestionnaireQuestionList }
	 * 
	 */
