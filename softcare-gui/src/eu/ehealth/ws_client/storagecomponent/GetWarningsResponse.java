 ...
 *       &lt;sequence>
 *         &lt;element name="out" type="{http://aladdin-project.eu/xsd}Warning" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetWarningsResponse {
     ...
     * 
     */
    public List<Warning> getOut() {
        if (out == null) {
            out = new ArrayList<Warning>();
        }
        return this.out;
    }
