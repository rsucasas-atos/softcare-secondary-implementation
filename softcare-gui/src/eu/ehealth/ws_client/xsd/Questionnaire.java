...
public class Questionnaire
{
	 ...
	 * @param title
	 */
	public Questionnaire(eu.ehealth.ws_client.xsd.QuestionnaireQuestion[] question,
			double version, java.lang.String ID, java.lang.String title)
	{
		this.question = Arrays.asList(question);
